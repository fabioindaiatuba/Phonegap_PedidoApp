...
angular.module('starter').controller('DetalheController', 
...
angular.module('starter').controller('PedidoController',	
	function($scope, ProdutosService, $stateParams,	$http, $state, $ionicPopup, $ionicLoading) {
		ProdutosService.lista().then(function(dados){
			$scope.bolo	=	dados[$stateParams.boloId];
		});
